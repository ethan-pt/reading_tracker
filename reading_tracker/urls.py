...
from .views import ReaderLogin, ReaderRegister, ReaderCreate, ReaderList, ReaderUpdate, ReaderDelete, ReaderSearch
...
urlpatterns = [
    ...
    path('book-search/', ReaderSearch.as_view(), name='book-search'),
